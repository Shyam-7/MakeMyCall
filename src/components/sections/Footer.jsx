      ...
      <ul className="list-none flex flex-col gap-2">
        {links.map((link) => (
          <li key={link.label}>
            <a
              href={link.href}
              className="text-sm text-muted no-underline transition-colors duration-150 hover:text-navy"
            >
              {link.label}
            </a>
          </li>
...
export default function Footer() {
  return (
    <footer className="bg-surface border-t border-border px-6 md:px-12 pt-10 pb-7">
      <div className="max-w-[1100px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1fr] gap-8 mb-7">
          <div>
            ...
            <p className="text-[13px] text-muted max-w-[220px] leading-normal">
